...
//         student_inout std = new student_inout();
...
//             {
//                 case 1: std.inputStudentINFO(ref name, ref score, idx); break;
//                 case 2: std.outputStudentINFO(ref name, ref score, idx); break;
...
// class student_inout
// {
//     public void inputStudentINFO(ref String[] name, ref int[] score, int idx)
//     {
...
//     public void input(ref String[] name, int idx)
//     {
//         Console.WriteLine("{0}번 학생의 이름은?", idx);
//         name[idx] = Console.ReadLine();
//     }

//     public void input(ref int[] score, int idx)
//     {
//         Console.WriteLine("{0}번 학생의 점수는?", idx);
//         score[idx] = Convert.ToInt32(Console.ReadLine());
//     }

//     public void outputStudentINFO(ref String[] name, ref int[] score, int idx)
//     {
//         int sum = 0;
//         for(int i = 0; i < idx; i++)
//         {
